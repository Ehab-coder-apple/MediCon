    ...
    <x-slot name="header">
        <div class="flex justify-between items-center gap-6 px-4 sm:px-6 lg:px-8">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Create Return Request - {{ $invoice->invoice_number }}
            </h2>
            @php
                $routePrefix = '';
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6 lg:p-8">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-900">{{ $invoice->customer->name ?? 'N/A' }}</p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-600">Total Items</p>
                            <p class="text-lg font-semibold text-gray-900">{{ $invoice->items->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <form action="{{ route($routePrefix . 'sales-returns.store', $invoice) }}" method="POST" class="p-6 lg:p-8">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <select id="refund_method" name="refund_method" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Invoice Qty</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <select name="items[{{ $index }}][reason]" class="w-40 px-2 py-1 border border-gray-300 rounded" required>
