...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-gray-100">
        ...
        <div class="min-h-screen flex">
            <!-- Sidebar -->
            <div class="w-64 shadow-lg" style="background-color: #1e40af !important;">
                <!-- Logo Section -->
                <div class="p-6 border-b border-gray-800">
                    <div class="flex items-center">
                        <img src="{{ asset('images/medicon-logo-light.svg') }}" alt="MediCon Logo" class="h-10 w-auto">
                        <span class="ml-2 text-sm font-bold" style="color: #FFFFFF !important;">Super Admin</span>
                    </div>
                </div>
                ...
                <div class="p-4 border-b border-gray-800">
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="font-semibold text-sm" style="color: #FFFFFF !important;">{{ auth()->user()->name }}</p>
                            <p class="text-xs" style="color: #D1D5DB !important;">Super Administrator</p>
                        </div>
                    </div>
                </div>
                ...
                <nav class="mt-4">
                    <!-- Dashboard -->
                    <a href="{{ route('super-admin.dashboard') }}" class="flex items-center px-6 py-3 hover:bg-gray-800 transition-colors {{ request()->routeIs('super-admin.dashboard') ? 'bg-purple-600 border-r-4 border-purple-400' : '' }}" style="color: #FFFFFF !important;">
                    ...
                    <!-- Tenant Management -->
                    <a href="{{ route('super-admin.tenants.index') }}" class="flex items-center px-6 py-3 hover:bg-gray-800 transition-colors {{ request()->routeIs('super-admin.tenants.*') ? 'bg-purple-600 border-r-4 border-purple-400' : '' }}" style="color: #FFFFFF !important;">
                        <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M19 7l-.867 12.142A2 2 0 0116.138 21H3.862a2 2 0 01-1.995-1.858L1 7m3 4v6m4-6v6m4-6v6M5 7V4a1 1 0 011-1h8a1 1 0 011 1v3M4 7h16"/>
                        </svg>
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="px-6">
                        @csrf
                        <button type="submit" class="flex items-center w-full py-3 hover:bg-gray-800 rounded-md transition-colors" style="color: #FFFFFF !important;">
                            <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
